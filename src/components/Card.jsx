...
function Card({filetype='xlsxs',filename,isDownload}) {
  return (
    <div className="card h-96 mt-10 ml-10 w-72 bg-[#FAF6F0] rounded-2xl flex flex-col justify-between  shadow-2xl cursor-pointer">
